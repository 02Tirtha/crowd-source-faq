...
export class ZoomFallback {
     ...
     */
    async getMeetings(userId, fetch, page = 1) {
    ...
    async getInsights(meetingId, fetch) {
        return this.withFallback({
    ...
    _retryDelay(err, attempt, baseDelay) {
