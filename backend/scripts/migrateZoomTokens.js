...
function looksEncrypted(value) {
    ...
    try {
        ...
        console.warn(`[migrateZoomTokens] Error checking if value looks encrypted: ${err.message}`);
        return false;
    }
}
async function migrateTokens() {
    ...
    for await (const doc of cursor) {
        totalChecked++;
        const accessToken = doc.zoomAccessToken;
        const refreshToken = doc.zoomRefreshToken;
