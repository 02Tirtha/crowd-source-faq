...
// ─── Retention runners ─────────────────────────────────────────────────────────
export async function cleanSearchLogs() {
...
async function run() {
    ...
    try {
        ...
        console.error('[retention] SearchLog cleanup failed:', e.message);
    }
    try {
        ...
        console.error('[retention] Notification cleanup failed:', e.message);
    }
    try {
        ...
        console.error('[retention] FreshReviewLog cleanup failed:', e.message);
    }
    try {
        ...
        console.error('[retention] ModerationLog cleanup failed:', e.message);
    }
    try {
        ...
        console.error('[retention] AdminLog cleanup failed:', e.message);
    }
